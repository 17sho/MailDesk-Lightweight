...
def test_qt_payload_filter_removes_all_chromium_resources() -> None:
    assert (
    ...
    assert not should_include_qt_payload("PySide6/resources/icudtl.dat")


def test_qt_payload_filter_removes_all_chromium_locales() -> None:
    for locale in ("en-US.pak", "zh-CN.pak", "en-GB.pak", "zh-TW.pak", "fr.pak"):
